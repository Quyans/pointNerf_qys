...
nrDataRoot="../data_src"
name='Truck_oriImg_ownPose_10'

resume_iter=best #best #
data_root="${nrDataRoot}/TanksAndTemple/"
scan="Truck_oriImg_ownPose"

num_point=819200 #819200
load_points=0
feat_grad=1
conf_grad=1
dir_grad=1
...
kernel_size=" 5 5 5 "
query_size=" 3 3 3 "
vsize=" 0.002 0.002 0.002 " #" 0.002 0.002 0.002 "
wcoord_query=1
z_depth_dim=400
max_o=2000000 #2000000
ranges="-4.0000  -4 -5.202693142822 5.287772425471 3.883214295749 5.054996349061"
SR=40
K=8
P=10 #120
NN=2
...
train_and_test=0 #1
test_num=10
test_freq=2000 #1200 #1200 #30184 #30184 #50000
print_freq=40
test_num_step=6
